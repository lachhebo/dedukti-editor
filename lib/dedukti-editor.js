...
export default {
  ...
  activate(state) {
   this.deduktiEditorView = new DeduktiEditorView(state.deduktiEditorViewState, null, null, null, null, null, null, null);
    ...
    //We are deleting the panel when the package is deactivated
     var end_dedkti = new Disposable(() => {
            ...
            if( (stop_cancelled ===0 ) && (obj_json.value[0] === "Feedback")) //If it's a feedback message
            {
              if(obj_json.value[1].event[0] == "Parsed"){ //If it's a parsed confirmation
                ...
                */
                  ...
                  //var panel_actif = atom.workspace.getActivePaneItem();
