        ...
        if (editor = atom.workspace.getActiveTextEditor()){
          ...
          cmd.get(
              ...
              function(err,data,stderr) {
                ...
                var result_in_json = data.replace(regex, ',\n');
                result_in_json = replaceLast(result_in_json, ',\n', ' \n ]');
                result_in_json = "[ \n"+result_in_json;

                var array_json = JSON.parse(result_in_json);
                ...
                for(i = 0; i< array_json.length; i++){ // For each line
                  if(array_json[i][0] === "Feedback")
                  {
                    ...
                    if(array_json[i][1].event[0] == "Parsed"){
                    ...
                    else if (array_json[i][1].event[0] === "False") {
                      ...
                      decoration = editor.decorateMarker(array_color_marker[array_json[i][1].span_id], {type: 'text', class:'Cancelled_line'});
                    }
  ...
  toggle() {
    ...
    //  */
      ...
      */
      ...
      json_file = new File(process.env['HOME']+"/github/dedukti-editor/resources/test_buffer.json"); // en dur pour l'instant
